...
class DataWilayah:
    ...
    def getProv(self):
        ...
        for i in range(len(reqProv)):
            print("Ambil Data Provinsi {}".format(reqProv[i]["nama_bps"]))
            self.provinsi["kode_bps"].append(str(reqProv[i]["kode_bps"]))
    ...
    def getKab(self):
        ...
        for i in range(len(self.provinsi["kode_bps"])):
            ...
            for j in range(len(reqKab)):
                print("Ambil Data Kabupaten {}".format(reqKab[j]["nama_bps"]))
                self.kabupaten["kode_provinsi"].append(str(self.provinsi["kode_bps"][i]))
                self.kabupaten["kode_bps"].append(str(reqKab[j]["kode_bps"]))
                self.kabupaten["nama_bps"].append(reqKab[j]["nama_bps"])
                self.kabupaten["kode_dagri"].append(reqKab[j]["kode_dagri"])
                self.kabupaten["nama_dagri"].append(reqKab[j]["nama_dagri"])
    ...
    def getKec(self):
        ...
        for i in range(len(self.kabupaten["kode_bps"])):
            ...
            for j in range(len(reqKec)):
                print("Ambil Data Kecamatan {}".format(reqKec[j]["nama_bps"]))
                self.kecamatan["kode_kab/kota"].append(str(self.kabupaten["kode_bps"][i]))
                self.kecamatan["kode_bps"].append(str(reqKec[j]["kode_bps"]))
                self.kecamatan["nama_bps"].append(reqKec[j]["nama_bps"])
                self.kecamatan["kode_dagri"].append(reqKec[j]["kode_dagri"])
                self.kecamatan["nama_dagri"].append(reqKec[j]["nama_dagri"])
    ...
    def getDes(self):
        ...
        for i in range(len(self.kecamatan["kode_bps"])):
            ...
            for j in range(len(reqDes)):
                print("Ambil Data Desa {}".format(reqDes[j]["nama_bps"]))
                self.desa["kode_kec"].append(str(self.kecamatan["kode_bps"][i]))
